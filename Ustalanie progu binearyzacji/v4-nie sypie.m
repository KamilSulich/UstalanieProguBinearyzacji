...
wybor_sposobu_wpisania_parametrow = input('1-domyslne parametry(progi od 0.1 do 0.8 obraz 3x3) , 2 -wpisanie recznie parametrow ');
...
subplot_numer_obrazu_org=ilosc_zdjec_na_osi_x*100+ilosc_zdjec_na_osi_y*10+numer_okienka_w_subplocie+1;
